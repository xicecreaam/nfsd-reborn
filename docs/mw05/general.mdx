...
Speedbreaker allows the player to enter a temporary state of slow motion (in-game time is slowed down by a factor of 4, ***source : game files***). But it is not the only ability the feature gives. It also approximatively triples your downforce and **doubles your car mass** and, so, can be useful to :
...
If you open the *World Map* by accident, your cursor might disappear. To avoid this, **unbind the *World Map* keybind** or you can open it again and **pull your cursor to one of the top corner**. The cursor is mandatory to perform the **Boss skip**.

If cops are chasing you during a race, there is a chance that actual and news cops can become <ins>bugged cops</ins>. To sum up, they will prefer to go numb instead of chasing you.

<details className="alert alert--info details">
  <summary>Buggy cop example</summary>
    <div className="video-container">
      <iframe
        className="responsive-iframe" src="https://www.youtube.com/embed/p7cDP_2SA0c" title="YouTube video player" loading="lazy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="true">
      </iframe>
    </div>
</details>
