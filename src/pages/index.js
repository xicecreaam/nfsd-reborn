      ...
      <main style={{ padding: '2rem', maxWidth: '2000px', textAlign: 'left' }}>
        ...
        <section style={{ marginTop: '3rem' }}>
          ...
          <ul style={{ listStyleType: 'none', padding: 0, marginTop: '1rem' }}>
            ...
            <li style={{ marginBottom: '0.5rem' }}>
              <Link to="/mw05" style={{ color: '#d94d4c' }}>Need for Speed: Most Wanted (2005)</Link> by <Link to="https://www.speedrun.com/users/SlivenKage" style={{ color: '#d94d4c' }}>SlivenKage</Link> and <Link to="https://www.speedrun.com/users/icecreaam" style={{ color: '#d94d4c' }}></Link>IceCream
            </li>
            <li style={{ marginBottom: '0.5rem' }}>
